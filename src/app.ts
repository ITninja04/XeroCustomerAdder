  ...
  private routes(): void {
    ...
    router.get("/contacts", async (req: Request, res: Response) => {
      try {
        ...
        console.log(contactsGetResponse.body)
        console.log(contactsGetResponse.response)

        const m = makeContacts();
        ...
        contactCreateResponse.body.contacts?.map(e => {
            console.log(`Created contact: ${e.contactID}`)
        })
        // // CREATE ONE OR MORE
